...
namespace Recipes.Pages.MenuRecipes
{
    public class ListModel : PageModel
    {
        ...
        public IActionResult OnGetFilteredSearch(MenuRecipeSearchModel menuRecipeSearchModel)
        {
            ...
            filterCount = ApplyFilter(menuRecipeSearchModel.IsCookTimeEntered, FilterType.EQUAL, "CookTimeMinutes", new List<string> { menuRecipeSearchModel.CookTimeSelected }, filters, filterCount);
